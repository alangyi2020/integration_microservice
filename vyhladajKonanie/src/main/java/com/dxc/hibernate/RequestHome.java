...
/**
 * Home object for domain model class Request.
 * @see com.dxc.hibernate.Request
 * @author Hibernate Tools
 */
public class RequestHome {

    private static final Log log = LogFactory.getLog(RequestHome.class);
    ...
    public void persist(Request transientInstance) {
        log.debug("persisting Request instance");
        try {
    ...
    public Request merge(Request detachedInstance) {
        ...
        try {
            Request result = (Request) sessionFactory.getCurrentSession().merge(detachedInstance);
    ...
    public Request findById(com.dxc.hibernate.RequestId id) {
