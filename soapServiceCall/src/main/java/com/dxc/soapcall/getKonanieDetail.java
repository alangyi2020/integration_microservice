...
public class getKonanieDetail {
	...
	public String callgetKonanieDetail(int request_id) throws SQLException {
        ...
        try {
        	 ...
        	 */
            int CSRU_Service_id = factory.getServiceProviderId("getKonanieDetail");
            ...
            if(request_type != 1) {
                ...
                for (RequestItems ri : Req_Items) {
                     ...
                     */
                    I_getKonanieDetail obj_Service = null;
                    obj_Service = new I_getKonanieDetail();
                    obj_Service.setURL(sp.getWsdlUrl());
                    
                   // RequestParameters aaa = (RequestParameters) factory.getRequest_parameters_by_SP_ID(sp.getServiceProviderId(), request_parameters);
                     ...
                     */
                    call_s =  obj_Service.callService();
                    ResponseXml = XMLUtil.toXML(obj_Service.getGetKonanieDetailResponse());
                   	myFile = "getGetKonanieDetailResponse" + request_id + "_" +  myDate.getTime() + ".xml";
