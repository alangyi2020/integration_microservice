...
public class sluzba_template {
	/*TODO 
	 * premenovat NazovSLuzby na skutocny nazov
	 */
	public String callNazovSluzby(int request_id) throws SQLException {
        String return_value = "";
        ...
        try {
        	 ...
        	 * premenovat NazovSLuzby na skutocny nazov
        	 */
            int CSRU_Service_id = factory.getServiceProviderId("NazovSluzby");
